...
plt.plot(snr_db_range, r_m, 'o-', label='Naive Robust')
plt.plot(snr_db_range[4:], r_m_o, 'o-', label='Robust')
...
plt.figure(figsize=(8,5))
plt.plot(snr_db_range, r_o, 'o-', label='Naive Robust')
plt.plot(snr_db_range[4:], r_o_o, 'o-', label='Robust')
